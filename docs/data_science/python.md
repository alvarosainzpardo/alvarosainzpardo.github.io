...
* [Interactive Visualizations In Jupyter Notebook](https://towardsdatascience.com/interactive-visualizations-in-jupyter-notebook-3be02ab2b8cd): gráficas interactivas usando Plotly y el módulo [ipywidgets](https://ipywidgets.readthedocs.io/en/stable/index.html) que permite añadir elementos de GUI interactivos a un notebook (menús, input box, etc). El módulo ipywidgets es una extensión de Jupyter Lab, y se instala de una forma específica
* [plotly.py GitHub Repo](https://github.com/plotly/plotly.py): con la información de releases, instalación. Incluye Plotly Express. La información de instalación de Plotly Express en los artículos de Medium está obsoleta
* Plotly Express
    * (2019) [Introducing Plotly Express](https://medium.com/plotly/introducing-plotly-express-808df010143d): [Plotly Express](https://plotly.com/python/plotly-express/) is a new high-level visualization library: it's a wrapper for [Plotly.py](https://plotly.com/python/) that exposes a simple syntax for complex charts. The code used to generate the screenshots below is available in our [walkthrough notebook](https://nbviewer.jupyter.org/github/plotly/plotly_express/blob/gh-pages/walkthrough.ipynb) which you can [load up on Binder](https://mybinder.org/v2/gh/plotly/plotly_express/gh-pages?filepath=walkthrough.ipynb) to play with right now in your browser without installing anything. Once you import Plotly Express (usually as px), most plots are made with just one function call that accepts a [tidy Pandas data frame](http://www.jeannicholashould.com/tidy-data-in-python.html), and a simple description of the plot you want to make.
